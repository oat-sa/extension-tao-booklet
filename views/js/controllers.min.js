...
Renderer.apply(this),this.register(renderersLocations),this.name=name||"",this.setOptions(_.defaults(options,defaultOptions||{}))};return NewRenderer.prototype=Renderer.prototype,NewRenderer}}}),define("taoItems/assets/strategies",["util/url"],function(urlUtil){"use strict";var prependToUrl=function(url,base,slashcat){return slashcat===!0?base.replace(/\/$/,"")+"/"+url.directory.replace(/^\.\//,"").replace(/^\//,"")+encodeURIComponent(url.file.replace(/^\.\//,"").replace(/^\//,"")):base+url.directory.replace(/^\.?\//,"")+encodeURIComponent(url.file.replace(/^\.?\//,""))},strategies={baseUrl:{name:"baseUrl",handle:function(url,data){if("string"==typeof data.baseUrl&&urlUtil.isRelative(url))return prependToUrl(url,data.baseUrl,data.slashcat);
}},itemCssNoCache:{name:"itemCssNoCache",handle:function(url,data){if("string"==typeof data.baseUrl&&urlUtil.isRelative(url)&&/\.css$/.test(url.file))return urlUtil.build(prependToUrl(url,data.baseUrl,data.slashcat),{bust:Date.now()})}},external:{name:"external",handle:function(url){if(urlUtil.isAbsolute(url))return url.toString()}},base64:{name:"base64",handle:function(url){if(urlUtil.isBase64(url))return url.toString()}},taomedia:{name:"taomedia",handle:function(url,data){var baseUrl=data.baseUrl||"./";if("object"==typeof url&&"taomedia"===url.protocol||/^taomedia:\/\//.test(url.toString()))return baseUrl+url.toString()}}};return strategies}),define("taoQtiPrint/qtiPrintRenderer/renderers/config",["taoItems/assets/manager","taoItems/assets/strategies"],function(assetManagerFactory,assetStrategies){
"use strict";var assetManager=assetManagerFactory([assetStrategies.taomedia,assetStrategies.external,assetStrategies.base64,assetStrategies.baseUrl],{baseUrl:""});return{name:"printRenderer",locations:{assessmentItem:"taoQtiPrint/qtiPrintRenderer/renderers/Item",_container:"taoQtiPrint/qtiPrintRenderer/renderers/Container",stylesheet:"taoQtiPrint/qtiPrintRenderer/renderers/Stylesheet",img:"taoQtiPrint/qtiPrintRenderer/renderers/Img",rubricBlock:"taoQtiPrint/qtiPrintRenderer/renderers/RubricBlock",object:"taoQtiPrint/qtiPrintRenderer/renderers/Object",prompt:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/Prompt",choiceInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/ChoiceInteraction",
matchInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/MatchInteraction",inlineChoiceInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/InlineChoiceInteraction",extendedTextInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/ExtendedTextInteraction",textEntryInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/TextEntryInteraction","simpleChoice.choiceInteraction":"taoQtiPrint/qtiPrintRenderer/renderers/choices/SimpleChoice.ChoiceInteraction","simpleAssociableChoice.matchInteraction":"taoQtiPrint/qtiPrintRenderer/renderers/choices/SimpleAssociableChoice.MatchInteraction",inlineChoice:"taoQtiPrint/qtiPrintRenderer/renderers/choices/InlineChoice",
math:"taoQtiPrint/qtiPrintRenderer/renderers/Math",_simpleFeedbackRule:!1,outcomeDeclaration:!1,responseDeclaration:!1,responseProcessing:!1,modalFeedback:!1,orderInteraction:!1,associateInteraction:!1,sliderInteraction:!1,"simpleChoice.orderInteraction":!1,hottext:!1,gap:!1,gapText:!1,"simpleAssociableChoice.associateInteraction":!1,hottextInteraction:!1,hotspotInteraction:!1,hotspotChoice:!1,associableHotspot:!1,gapMatchInteraction:!1,selectPointInteraction:!1,graphicOrderInteraction:!1,mediaInteraction:!1,uploadInteraction:!1,graphicGapMatchInteraction:!1,gapImg:!1,graphicAssociateInteraction:!1,customInteraction:!1,infoControl:!1,endAttemptInteraction:!1},
options:{assetManager:assetManager}}}),define("taoQtiPrint/qtiPrintRenderer/renderers/Renderer",["taoQtiItem/qtiRunner/core/Renderer","taoQtiPrint/qtiPrintRenderer/renderers/config","css!taoQtiPrintCss/qti.css"],function(Renderer,config){"use strict";return Renderer.build(config.locations,config.name,config.options)}),define("tpl!taoQtiPrint/qtiPrintRenderer/tpl/notYetSupported",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){function program1(depth0,data){var stack1,helper,buffer="";return buffer+='\n    <div class="additional">\n        <div class="title">Additional information:</div>\n        <p class="info">',
...
for(var c=8;c<this.moduleCount-8;c++)null==this.modules[6][c]&&(this.modules[6][c]=c%2==0)},setupPositionAdjustPattern:function(){for(var pos=QRUtil.getPatternPosition(this.typeNumber),i=0;i<pos.length;i++)for(var j=0;j<pos.length;j++){var row=pos[i],col=pos[j];if(null==this.modules[row][col])for(var r=-2;r<=2;r++)for(var c=-2;c<=2;c++)r==-2||2==r||c==-2||2==c||0==r&&0==c?this.modules[row+r][col+c]=!0:this.modules[row+r][col+c]=!1}},setupTypeNumber:function(test){for(var bits=QRUtil.getBCHTypeNumber(this.typeNumber),i=0;i<18;i++){var mod=!test&&1==(bits>>i&1);this.modules[Math.floor(i/3)][i%3+this.moduleCount-8-3]=mod}for(var i=0;i<18;i++){var mod=!test&&1==(bits>>i&1);
...
buffer+="\n",stack1=helpers.if.call(depth0,depth0&&depth0.qrcode,{hash:{},inverse:self.noop,fn:self.program(7,program7,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n</section>\n"})}),define("tpl!taoQtiPrint/runner/tpl/pageSection",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){function program1(depth0,data){var buffer="";return buffer+="\n    <div>"+escapeExpression(typeof depth0===functionType?depth0.apply(depth0):depth0)+"</div>\n    "}this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression,self=this;
return buffer+='<section class="section">\n\n    <h2>',(helper=helpers.title)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.title,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+"</h2>\n    ",stack1=helpers.each.call(depth0,depth0&&depth0.rubricBlock,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n\n</section>"})}),define("tpl!taoQtiPrint/runner/tpl/pageItem",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),
data=data||{},'<section class="item">\n\n</section>'})}),define("taoQtiPrint/runner/testRunner",["jquery","lodash","async","util/url","core/eventifier","taoQtiPrint/runner/itemRunner","taoItems/assets/strategies","taoQtiPrint/lib/qrcode","tpl!taoQtiPrint/runner/tpl/pageTest","tpl!taoQtiPrint/runner/tpl/pageSection","tpl!taoQtiPrint/runner/tpl/pageItem"],function($,_,asyncLib,urlHelper,eventifier,itemRunner,assetStrategies,QRCode,pageTestTpl,pageSectionTpl,pageItemTpl){"use strict";var testRenderer={createPage:function(type){return $("<section></section>").addClass(type)},testPage:function(test,options,done){var coverPageOptions=options&&options.cover_page||{},$content=$(pageTestTpl({
title:coverPageOptions.title&&test.title,subtitle:coverPageOptions.description&&options.description,qrcode:coverPageOptions.qr_code,logo:coverPageOptions.logo&&options.logo,date:coverPageOptions.date&&options.date}));coverPageOptions.qr_code&&new QRCode($(".qr-code",$content).get(0),{text:urlHelper.route("render","PrintTest","taoBooklet",{uri:test.uri}),width:192,height:192,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H}),done(null,$content)},sectionPage:function(section,pageNum,done){var $content=$(pageSectionTpl({title:section.title,rubricBlock:section.rubricBlock}));done(null,$content)},itemPage:function(item,uri,pageNum,assets,done){
var $content=$(pageItemTpl());itemRunner("qtiprint",item).on("error",function(err){done(err)}).on("render",function(){done(null,$content)}).assets([assetStrategies.taomedia,assetStrategies.external,{name:"packageAssetHandler",handle:function(url){for(var type in assets)if(assets[type][url.toString()])return assets[type][url.toString()]}}],{baseUrl:urlHelper.route("getFile","QtiCreator","taoQtiItem",{uri:uri,lang:"en-US"})+"&relPath="}).init().render($content)}},testRunnerFactory=function(testData,options){var layoutOptions=options&&options.layout||{},testRunner=eventifier({$container:null,render:function(elt){var self=this,pageRenderers=[];return elt instanceof HTMLElement||elt instanceof $?(elt instanceof $?this.$container=elt:this.$container=$(elt),
layoutOptions.cover_page&&pageRenderers.push(_.bind(_.partial(testRenderer.testPage,testData.data,options),testRenderer)),_.forEach(testData.data.testParts,function(testPart){_.forEach(testPart.sections,function(section){pageRenderers.push(_.bind(_.partial(testRenderer.sectionPage,section,pageRenderers.length),testRenderer)),_.forEach(section.items,function(item){testData.items[item.href]&&testData.items[item.href].data&&pageRenderers.push(_.bind(_.partial(testRenderer.itemPage,testData.items[item.href].data,item.href,pageRenderers.length,testData.items[item.href].assets),testRenderer))})})}),asyncLib.parallel(pageRenderers,function(err,$results){err&&self.trigger("error","An error occurred while rendering a page :  "+err),
options&&options.rtl===!0&&self.$container.addClass("rtl").attr("dir","rtl"),self.$container.empty().append($results),self.trigger("render"),self.trigger("ready")}),this):self.trigger("error","A valid HTMLElement (or a jquery element) at least is required to render the test")},clear:function(){return this.$container.empty(),this.trigger("clear"),this}});if(testData=testData||{},!testData||!testData.data||!testData.items)throw new Error("Invalid test data structure");return testRunner};return testRunnerFactory}),define("taoBooklet/controller/printtest/render",["jquery","core/logger","taoQtiPrint/runner/testRunner"],function($,loggerFactory,testRunner){"use strict";
var logger=loggerFactory("printtest/render"),ready=function(){window.status="runner-ready"},showMessage=function(msg,type){type=type||"info",$("body").append('<div class="feedback-'+type+'">'+msg+"</div>")},printLayoutHacking=function($container){var previous,threshold=6e3,pages=2,blankPage=function($section){$section.before('<div class="breaker"></div>'),pages++},computePageFromHeight=function(height){height>threshold&&(pages+=Math.ceil(height/threshold)-1)};$container.children("section").each(function(){var height,$section=$(this);$section.hasClass("section")&&(pages%2===0&&blankPage($section),computePageFromHeight($section.outerHeight()),previous="section",
pages++),$section.hasClass("item")&&("item"!==previous&&(pages%2!==0&&blankPage($section),height=$section.outerHeight(),$section.nextUntil(".section",".item").each(function(){height+=$(this).outerHeight()}),computePageFromHeight(height),pages++),previous="item")})},renderController={start:function(testData,options){var layoutOptions=options&&options.layout||{},timeout=setTimeout(function(){showMessage("Something went wrong...","error"),ready()},45e3),$mainContainer=$("<main>");layoutOptions.one_page_item&&$("body").addClass("one-item-per-page"),layoutOptions.one_page_section&&$("body").addClass("one-section-per-page"),testRunner(testData,options).on("error",function(e){
logger.error(e),showMessage(e,"error"),ready()}).on("ready",function(){$("body").append($mainContainer),layoutOptions.add_blank_pages&&printLayoutHacking($mainContainer),clearTimeout(timeout),ready()}).render($mainContainer)}};return renderController});
