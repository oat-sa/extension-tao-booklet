...
};return NewRenderer.prototype=Renderer.prototype,NewRenderer}}}),define("taoQtiPrint/qtiPrintRenderer/renderers/config",[],function(){return{name:"printRenderer",locations:{assessmentItem:"taoQtiPrint/qtiPrintRenderer/renderers/Item",_container:"taoQtiPrint/qtiPrintRenderer/renderers/Container",stylesheet:"taoQtiPrint/qtiPrintRenderer/renderers/Stylesheet",img:"taoQtiPrint/qtiPrintRenderer/renderers/Img",rubricBlock:"taoQtiPrint/qtiPrintRenderer/renderers/RubricBlock",object:"taoQtiPrint/qtiPrintRenderer/renderers/Object",prompt:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/Prompt",choiceInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/ChoiceInteraction",extendedTextInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/ExtendedTextInteraction",textEntryInteraction:"taoQtiPrint/qtiPrintRenderer/renderers/interactions/TextEntryInteraction","simpleChoice.choiceInteraction":"taoQtiPrint/qtiPrintRenderer/renderers/choices/SimpleChoice.ChoiceInteraction",_simpleFeedbackRule:!1,outcomeDeclaration:!1,responseDeclaration:!1,responseProcessing:!1,modalFeedback:!1,orderInteraction:!1,associateInteraction:!1,matchInteraction:!1,sliderInteraction:!1,"simpleChoice.orderInteraction":!1,hottext:!1,gap:!1,gapText:!1,"simpleAssociableChoice.matchInteraction":!1,"simpleAssociableChoice.associateInteraction":!1,hottextInteraction:!1,hotspotInteraction:!1,gapMatchInteraction:!1,inlineChoiceInteraction:!1,inlineChoice:!1,selectPointInteraction:!1,graphicOrderInteraction:!1,mediaInteraction:!1,uploadInteraction:!1,graphicGapMatchInteraction:!1,gapImg:!1,graphicAssociateInteraction:!1,customInteraction:!1,infoControl:!1,endAttemptInteraction:!1}}
}),define("css!taoQtiPrintCss/qti",[],function(){}),define("taoQtiPrint/qtiPrintRenderer/renderers/Renderer",["taoQtiItem/qtiRunner/core/Renderer","taoQtiPrint/qtiPrintRenderer/renderers/config","css!taoQtiPrintCss/qti.css"],function(Renderer,config){return Renderer.build(config.locations,config.name)}),define("taoQtiPrint/runner/provider/qtiprint",["helpers","taoQtiItem/qtiItem/core/Loader","taoQtiPrint/qtiPrintRenderer/renderers/Renderer"],function(helpers,QtiLoader,QtiRenderer){var qtiItemRuntimeProvider={init:function(itemData,done){var self=this;this._renderer=new QtiRenderer({baseUrl:helpers._url("getFile","QtiCreator","taoQtiItem",{uri:this.options.uri,lang:"en-US"})+"&relPath="}),(new QtiLoader).loadItemData(itemData,function(item){if(!item)return self.trigger("error","Unable to load item from the given data.");
self._item=item;try{self._renderer.load(function(){self._item.setRenderer(this),done()},this.getLoadedClasses())}catch(e){self.trigger("error","Unable to render the item : "+e)}})},render:function(elt,done){var self=this;if(this._item){try{elt.innerHTML=this._item.render({})}catch(e){console.error(e),self.trigger("error","Error in template rendering : "+e)}try{this._item.postRender()}catch(e){console.error(e),self.trigger("error","Error in post rendering : "+e)}done()}},clear:function(elt,done){done()},getState:function(){return{}},setState:function(){},getResponses:function(){return[]}};return qtiItemRuntimeProvider}),define("taoQtiPrint/runner/itemRunner",["taoItems/runner/api/itemRunner","taoQtiPrint/runner/provider/qtiprint"],function(itemRunner,qtiRuntimeProvider){return itemRunner.register("qtiprint",qtiRuntimeProvider),itemRunner
}),define("taoQtiPrint/lib/qrcode",[],function(){function QR8bitByte(data){this.mode=QRMode.MODE_8BIT_BYTE,this.data=data,this.parsedData=[];for(var i=0,l=this.data.length;l>i;i++){var byteArray=[],code=this.data.charCodeAt(i);code>65536?(byteArray[0]=240|(1835008&code)>>>18,byteArray[1]=128|(258048&code)>>>12,byteArray[2]=128|(4032&code)>>>6,byteArray[3]=128|63&code):code>2048?(byteArray[0]=224|(61440&code)>>>12,byteArray[1]=128|(4032&code)>>>6,byteArray[2]=128|63&code):code>128?(byteArray[0]=192|(1984&code)>>>6,byteArray[1]=128|63&code):byteArray[0]=code,this.parsedData.push(byteArray)}this.parsedData=Array.prototype.concat.apply([],this.parsedData),this.parsedData.length!=this.data.length&&(this.parsedData.unshift(191),this.parsedData.unshift(187),this.parsedData.unshift(239))
...
}function _getAndroid(){var android=!1,sAgent=navigator.userAgent;if(/android/i.test(sAgent)){android=!0;var aMat=sAgent.toString().match(/android ([0-9]\.[0-9])/i);aMat&&aMat[1]&&(android=parseFloat(aMat[1]))}return android}function _getTypeNumber(sText,nCorrectLevel){for(var nType=1,length=_getUTF8Length(sText),i=0,len=QRCodeLimitLength.length;len>=i;i++){var nLimit=0;switch(nCorrectLevel){case QRErrorCorrectLevel.L:nLimit=QRCodeLimitLength[i][0];break;case QRErrorCorrectLevel.M:nLimit=QRCodeLimitLength[i][1];break;case QRErrorCorrectLevel.Q:nLimit=QRCodeLimitLength[i][2];break;case QRErrorCorrectLevel.H:nLimit=QRCodeLimitLength[i][3]}if(nLimit>=length)break;
nType++}if(nType>QRCodeLimitLength.length)throw new Error("Too long data");return nType}function _getUTF8Length(sText){var replacedText=encodeURI(sText).toString().replace(/\%[0-9a-fA-F]{2}/g,"a");return replacedText.length+(replacedText.length!=sText?3:0)}var QRCode;QR8bitByte.prototype={getLength:function(){return this.parsedData.length},write:function(buffer){for(var i=0,l=this.parsedData.length;l>i;i++)buffer.put(this.parsedData[i],8)}},QRCodeModel.prototype={addData:function(data){var newData=new QR8bitByte(data);this.dataList.push(newData),this.dataCache=null},isDark:function(row,col){if(0>row||this.moduleCount<=row||0>col||this.moduleCount<=col)throw new Error(row+","+col);
...
},setupPositionProbePattern:function(row,col){for(var r=-1;7>=r;r++)if(!(-1>=row+r||this.moduleCount<=row+r))for(var c=-1;7>=c;c++)-1>=col+c||this.moduleCount<=col+c||(this.modules[row+r][col+c]=r>=0&&6>=r&&(0==c||6==c)||c>=0&&6>=c&&(0==r||6==r)||r>=2&&4>=r&&c>=2&&4>=c?!0:!1)},getBestMaskPattern:function(){for(var minLostPoint=0,pattern=0,i=0;8>i;i++){this.makeImpl(!0,i);var lostPoint=QRUtil.getLostPoint(this);(0==i||minLostPoint>lostPoint)&&(minLostPoint=lostPoint,pattern=i)}return pattern},createMovieClip:function(target_mc,instance_name,depth){var qr_mc=target_mc.createEmptyMovieClip(instance_name,depth),cs=1;this.make();for(var row=0;row<this.modules.length;row++)for(var y=row*cs,col=0;col<this.modules[row].length;col++){var x=col*cs,dark=this.modules[row][col];
dark&&(qr_mc.beginFill(0,100),qr_mc.moveTo(x,y),qr_mc.lineTo(x+cs,y),qr_mc.lineTo(x+cs,y+cs),qr_mc.lineTo(x,y+cs),qr_mc.endFill())}return qr_mc},setupTimingPattern:function(){for(var r=8;r<this.moduleCount-8;r++)null==this.modules[r][6]&&(this.modules[r][6]=r%2==0);for(var c=8;c<this.moduleCount-8;c++)null==this.modules[6][c]&&(this.modules[6][c]=c%2==0)},setupPositionAdjustPattern:function(){for(var pos=QRUtil.getPatternPosition(this.typeNumber),i=0;i<pos.length;i++)for(var j=0;j<pos.length;j++){var row=pos[i],col=pos[j];if(null==this.modules[row][col])for(var r=-2;2>=r;r++)for(var c=-2;2>=c;c++)this.modules[row+r][col+c]=-2==r||2==r||-2==c||2==c||0==r&&0==c?!0:!1
}},setupTypeNumber:function(test){for(var bits=QRUtil.getBCHTypeNumber(this.typeNumber),i=0;18>i;i++){var mod=!test&&1==(bits>>i&1);this.modules[Math.floor(i/3)][i%3+this.moduleCount-8-3]=mod}for(var i=0;18>i;i++){var mod=!test&&1==(bits>>i&1);this.modules[i%3+this.moduleCount-8-3][Math.floor(i/3)]=mod}},setupTypeInfo:function(test,maskPattern){for(var data=this.errorCorrectLevel<<3|maskPattern,bits=QRUtil.getBCHTypeInfo(data),i=0;15>i;i++){var mod=!test&&1==(bits>>i&1);6>i?this.modules[i][8]=mod:8>i?this.modules[i+1][8]=mod:this.modules[this.moduleCount-15+i][8]=mod}for(var i=0;15>i;i++){var mod=!test&&1==(bits>>i&1);8>i?this.modules[8][this.moduleCount-i-1]=mod:9>i?this.modules[8][15-i-1+1]=mod:this.modules[8][15-i-1]=mod
}this.modules[this.moduleCount-8][8]=!test},mapData:function(data,maskPattern){for(var inc=-1,row=this.moduleCount-1,bitIndex=7,byteIndex=0,col=this.moduleCount-1;col>0;col-=2)for(6==col&&col--;;){for(var c=0;2>c;c++)if(null==this.modules[row][col-c]){var dark=!1;byteIndex<data.length&&(dark=1==(data[byteIndex]>>>bitIndex&1));var mask=QRUtil.getMask(maskPattern,row,col-c);mask&&(dark=!dark),this.modules[row][col-c]=dark,bitIndex--,-1==bitIndex&&(byteIndex++,bitIndex=7)}if(row+=inc,0>row||this.moduleCount<=row){row-=inc,inc=-inc;break}}}},QRCodeModel.PAD0=236,QRCodeModel.PAD1=17,QRCodeModel.createData=function(typeNumber,errorCorrectLevel,dataList){for(var rsBlocks=QRRSBlock.getRSBlocks(typeNumber,errorCorrectLevel),buffer=new QRBitBuffer,i=0;i<dataList.length;i++){var data=dataList[i];
buffer.put(data.mode,4),buffer.put(data.getLength(),QRUtil.getLengthInBits(data.mode,typeNumber)),data.write(buffer)}for(var totalDataCount=0,i=0;i<rsBlocks.length;i++)totalDataCount+=rsBlocks[i].dataCount;if(buffer.getLengthInBits()>8*totalDataCount)throw new Error("code length overflow. ("+buffer.getLengthInBits()+">"+8*totalDataCount+")");for(buffer.getLengthInBits()+4<=8*totalDataCount&&buffer.put(0,4);buffer.getLengthInBits()%8!=0;)buffer.putBit(!1);for(;;){if(buffer.getLengthInBits()>=8*totalDataCount)break;if(buffer.put(QRCodeModel.PAD0,8),buffer.getLengthInBits()>=8*totalDataCount)break;buffer.put(QRCodeModel.PAD1,8)}return QRCodeModel.createBytes(buffer,rsBlocks)
},QRCodeModel.createBytes=function(buffer,rsBlocks){for(var offset=0,maxDcCount=0,maxEcCount=0,dcdata=new Array(rsBlocks.length),ecdata=new Array(rsBlocks.length),r=0;r<rsBlocks.length;r++){var dcCount=rsBlocks[r].dataCount,ecCount=rsBlocks[r].totalCount-dcCount;maxDcCount=Math.max(maxDcCount,dcCount),maxEcCount=Math.max(maxEcCount,ecCount),dcdata[r]=new Array(dcCount);for(var i=0;i<dcdata[r].length;i++)dcdata[r][i]=255&buffer.buffer[i+offset];offset+=dcCount;var rsPoly=QRUtil.getErrorCorrectPolynomial(ecCount),rawPoly=new QRPolynomial(dcdata[r],rsPoly.getLength()-1),modPoly=rawPoly.mod(rsPoly);ecdata[r]=new Array(rsPoly.getLength()-1);for(var i=0;i<ecdata[r].length;i++){var modIndex=i+modPoly.getLength()-ecdata[r].length;
...
return(data<<10|d)^QRUtil.G15_MASK},getBCHTypeNumber:function(data){for(var d=data<<12;QRUtil.getBCHDigit(d)-QRUtil.getBCHDigit(QRUtil.G18)>=0;)d^=QRUtil.G18<<QRUtil.getBCHDigit(d)-QRUtil.getBCHDigit(QRUtil.G18);return data<<12|d},getBCHDigit:function(data){for(var digit=0;0!=data;)digit++,data>>>=1;return digit},getPatternPosition:function(typeNumber){return QRUtil.PATTERN_POSITION_TABLE[typeNumber-1]},getMask:function(maskPattern,i,j){switch(maskPattern){case QRMaskPattern.PATTERN000:return(i+j)%2==0;case QRMaskPattern.PATTERN001:return i%2==0;case QRMaskPattern.PATTERN010:return j%3==0;case QRMaskPattern.PATTERN011:return(i+j)%3==0;case QRMaskPattern.PATTERN100:return(Math.floor(i/2)+Math.floor(j/3))%2==0;
case QRMaskPattern.PATTERN101:return i*j%2+i*j%3==0;case QRMaskPattern.PATTERN110:return(i*j%2+i*j%3)%2==0;case QRMaskPattern.PATTERN111:return(i*j%3+(i+j)%2)%2==0;default:throw new Error("bad maskPattern:"+maskPattern)}},getErrorCorrectPolynomial:function(errorCorrectLength){for(var a=new QRPolynomial([1],0),i=0;errorCorrectLength>i;i++)a=a.multiply(new QRPolynomial([1,QRMath.gexp(i)],0));return a},getLengthInBits:function(mode,type){if(type>=1&&10>type)switch(mode){case QRMode.MODE_NUMBER:return 10;case QRMode.MODE_ALPHA_NUM:return 9;case QRMode.MODE_8BIT_BYTE:return 8;case QRMode.MODE_KANJI:return 8;default:throw new Error("mode:"+mode)}else if(27>type)switch(mode){case QRMode.MODE_NUMBER:return 12;
case QRMode.MODE_ALPHA_NUM:return 11;case QRMode.MODE_8BIT_BYTE:return 16;case QRMode.MODE_KANJI:return 10;default:throw new Error("mode:"+mode)}else{if(!(41>type))throw new Error("type:"+type);switch(mode){case QRMode.MODE_NUMBER:return 14;case QRMode.MODE_ALPHA_NUM:return 13;case QRMode.MODE_8BIT_BYTE:return 16;case QRMode.MODE_KANJI:return 12;default:throw new Error("mode:"+mode)}}},getLostPoint:function(qrCode){for(var moduleCount=qrCode.getModuleCount(),lostPoint=0,row=0;moduleCount>row;row++)for(var col=0;moduleCount>col;col++){for(var sameCount=0,dark=qrCode.isDark(row,col),r=-1;1>=r;r++)if(!(0>row+r||row+r>=moduleCount))for(var c=-1;1>=c;c++)0>col+c||col+c>=moduleCount||(0!=r||0!=c)&&dark==qrCode.isDark(row+r,col+c)&&sameCount++;
sameCount>5&&(lostPoint+=3+sameCount-5)}for(var row=0;moduleCount-1>row;row++)for(var col=0;moduleCount-1>col;col++){var count=0;qrCode.isDark(row,col)&&count++,qrCode.isDark(row+1,col)&&count++,qrCode.isDark(row,col+1)&&count++,qrCode.isDark(row+1,col+1)&&count++,(0==count||4==count)&&(lostPoint+=3)}for(var row=0;moduleCount>row;row++)for(var col=0;moduleCount-6>col;col++)qrCode.isDark(row,col)&&!qrCode.isDark(row,col+1)&&qrCode.isDark(row,col+2)&&qrCode.isDark(row,col+3)&&qrCode.isDark(row,col+4)&&!qrCode.isDark(row,col+5)&&qrCode.isDark(row,col+6)&&(lostPoint+=40);for(var col=0;moduleCount>col;col++)for(var row=0;moduleCount-6>row;row++)qrCode.isDark(row,col)&&!qrCode.isDark(row+1,col)&&qrCode.isDark(row+2,col)&&qrCode.isDark(row+3,col)&&qrCode.isDark(row+4,col)&&!qrCode.isDark(row+5,col)&&qrCode.isDark(row+6,col)&&(lostPoint+=40);
for(var darkCount=0,col=0;moduleCount>col;col++)for(var row=0;moduleCount>row;row++)qrCode.isDark(row,col)&&darkCount++;var ratio=Math.abs(100*darkCount/moduleCount/moduleCount-50)/5;return lostPoint+=10*ratio}},QRMath={glog:function(n){if(1>n)throw new Error("glog("+n+")");return QRMath.LOG_TABLE[n]},gexp:function(n){for(;0>n;)n+=255;for(;n>=256;)n-=255;return QRMath.EXP_TABLE[n]},EXP_TABLE:new Array(256),LOG_TABLE:new Array(256)},i=0;8>i;i++)QRMath.EXP_TABLE[i]=1<<i;for(var i=8;256>i;i++)QRMath.EXP_TABLE[i]=QRMath.EXP_TABLE[i-4]^QRMath.EXP_TABLE[i-5]^QRMath.EXP_TABLE[i-6]^QRMath.EXP_TABLE[i-8];for(var i=0;255>i;i++)QRMath.LOG_TABLE[QRMath.EXP_TABLE[i]]=i;QRPolynomial.prototype={get:function(index){return this.num[index]
},getLength:function(){return this.num.length},multiply:function(e){for(var num=new Array(this.getLength()+e.getLength()-1),i=0;i<this.getLength();i++)for(var j=0;j<e.getLength();j++)num[i+j]^=QRMath.gexp(QRMath.glog(this.get(i))+QRMath.glog(e.get(j)));return new QRPolynomial(num,0)},mod:function(e){if(this.getLength()-e.getLength()<0)return this;for(var ratio=QRMath.glog(this.get(0))-QRMath.glog(e.get(0)),num=new Array(this.getLength()),i=0;i<this.getLength();i++)num[i]=this.get(i);for(var i=0;i<e.getLength();i++)num[i]^=QRMath.gexp(QRMath.glog(e.get(i))+ratio);return new QRPolynomial(num,0).mod(e)}},QRRSBlock.RS_BLOCK_TABLE=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],QRRSBlock.getRSBlocks=function(typeNumber,errorCorrectLevel){var rsBlock=QRRSBlock.getRsBlockTable(typeNumber,errorCorrectLevel);
if(void 0==rsBlock)throw new Error("bad rs block @ typeNumber:"+typeNumber+"/errorCorrectLevel:"+errorCorrectLevel);for(var length=rsBlock.length/3,list=[],i=0;length>i;i++)for(var count=rsBlock[3*i+0],totalCount=rsBlock[3*i+1],dataCount=rsBlock[3*i+2],j=0;count>j;j++)list.push(new QRRSBlock(totalCount,dataCount));return list},QRRSBlock.getRsBlockTable=function(typeNumber,errorCorrectLevel){switch(errorCorrectLevel){case QRErrorCorrectLevel.L:return QRRSBlock.RS_BLOCK_TABLE[4*(typeNumber-1)+0];case QRErrorCorrectLevel.M:return QRRSBlock.RS_BLOCK_TABLE[4*(typeNumber-1)+1];case QRErrorCorrectLevel.Q:return QRRSBlock.RS_BLOCK_TABLE[4*(typeNumber-1)+2];case QRErrorCorrectLevel.H:return QRRSBlock.RS_BLOCK_TABLE[4*(typeNumber-1)+3];
default:return void 0}},QRBitBuffer.prototype={get:function(index){var bufIndex=Math.floor(index/8);return 1==(this.buffer[bufIndex]>>>7-index%8&1)},put:function(num,length){for(var i=0;length>i;i++)this.putBit(1==(num>>>length-i-1&1))},getLengthInBits:function(){return this.length},putBit:function(bit){var bufIndex=Math.floor(this.length/8);this.buffer.length<=bufIndex&&this.buffer.push(0),bit&&(this.buffer[bufIndex]|=128>>>this.length%8),this.length++}};var QRCodeLimitLength=[[17,14,11,7],[32,26,20,14],[53,42,32,24],[78,62,46,34],[106,84,60,44],[134,106,74,58],[154,122,86,64],[192,152,108,84],[230,180,130,98],[271,213,151,119],[321,251,177,137],[367,287,203,155],[425,331,241,177],[458,362,258,194],[520,412,292,220],[586,450,322,250],[644,504,364,280],[718,560,394,310],[792,624,442,338],[858,666,482,382],[929,711,509,403],[1003,779,565,439],[1091,857,611,461],[1171,911,661,511],[1273,997,715,535],[1367,1059,751,593],[1465,1125,805,625],[1528,1190,868,658],[1628,1264,908,698],[1732,1370,982,742],[1840,1452,1030,790],[1952,1538,1112,842],[2068,1628,1168,898],[2188,1722,1228,958],[2303,1809,1283,983],[2431,1911,1351,1051],[2563,1989,1423,1093],[2699,2099,1499,1139],[2809,2213,1579,1219],[2953,2331,1663,1273]],svgDrawer=function(){var Drawing=function(el,htOption){this._el=el,this._htOption=htOption
};return Drawing.prototype.draw=function(oQRCode){function makeSVG(tag,attrs){var el=document.createElementNS("http://www.w3.org/2000/svg",tag);for(var k in attrs)attrs.hasOwnProperty(k)&&el.setAttribute(k,attrs[k]);return el}{var _htOption=this._htOption,_el=this._el,nCount=oQRCode.getModuleCount();Math.floor(_htOption.width/nCount),Math.floor(_htOption.height/nCount)}this.clear();var svg=makeSVG("svg",{viewBox:"0 0 "+String(nCount)+" "+String(nCount),width:"100%",height:"100%",fill:_htOption.colorLight});svg.setAttributeNS("http://www.w3.org/2000/xmlns/","xmlns:xlink","http://www.w3.org/1999/xlink"),_el.appendChild(svg),svg.appendChild(makeSVG("rect",{fill:_htOption.colorLight,width:"100%",height:"100%"})),svg.appendChild(makeSVG("rect",{fill:_htOption.colorDark,width:"1",height:"1",id:"template"}));
for(var row=0;nCount>row;row++)for(var col=0;nCount>col;col++)if(oQRCode.isDark(row,col)){var child=makeSVG("use",{x:String(row),y:String(col)});child.setAttributeNS("http://www.w3.org/1999/xlink","href","#template"),svg.appendChild(child)}},Drawing.prototype.clear=function(){for(;this._el.hasChildNodes();)this._el.removeChild(this._el.lastChild)},Drawing}(),useSVG="svg"===document.documentElement.tagName.toLowerCase(),Drawing=useSVG?svgDrawer:_isSupportCanvas()?function(){function _onMakeImage(){this._elImage.src=this._elCanvas.toDataURL("image/png"),this._elImage.style.display="block",this._elCanvas.style.display="none"}function _safeSetDataURI(fSuccess,fFail){var self=this;
if(self._fFail=fFail,self._fSuccess=fSuccess,null===self._bSupportDataURI){var el=document.createElement("img"),fOnError=function(){self._bSupportDataURI=!1,self._fFail&&self._fFail.call(self)},fOnSuccess=function(){self._bSupportDataURI=!0,self._fSuccess&&self._fSuccess.call(self)};return el.onabort=fOnError,el.onerror=fOnError,el.onload=fOnSuccess,void(el.src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==")}self._bSupportDataURI===!0&&self._fSuccess?self._fSuccess.call(self):self._bSupportDataURI===!1&&self._fFail&&self._fFail.call(self)}if(this._android&&this._android<=2.1){var factor=1/window.devicePixelRatio,drawImage=CanvasRenderingContext2D.prototype.drawImage;
CanvasRenderingContext2D.prototype.drawImage=function(image,sx,sy,sw,sh,dx,dy,dw){if("nodeName"in image&&/img/i.test(image.nodeName))for(var i=arguments.length-1;i>=1;i--)arguments[i]=arguments[i]*factor;else"undefined"==typeof dw&&(arguments[1]*=factor,arguments[2]*=factor,arguments[3]*=factor,arguments[4]*=factor);drawImage.apply(this,arguments)}}var Drawing=function(el,htOption){this._bIsPainted=!1,this._android=_getAndroid(),this._htOption=htOption,this._elCanvas=document.createElement("canvas"),this._elCanvas.width=htOption.width,this._elCanvas.height=htOption.height,el.appendChild(this._elCanvas),this._el=el,this._oContext=this._elCanvas.getContext("2d"),this._bIsPainted=!1,this._elImage=document.createElement("img"),this._elImage.alt="Scan me!",this._elImage.style.display="none",this._el.appendChild(this._elImage),this._bSupportDataURI=null
};return Drawing.prototype.draw=function(oQRCode){var _elImage=this._elImage,_oContext=this._oContext,_htOption=this._htOption,nCount=oQRCode.getModuleCount(),nWidth=_htOption.width/nCount,nHeight=_htOption.height/nCount,nRoundedWidth=Math.round(nWidth),nRoundedHeight=Math.round(nHeight);_elImage.style.display="none",this.clear();for(var row=0;nCount>row;row++)for(var col=0;nCount>col;col++){var bIsDark=oQRCode.isDark(row,col),nLeft=col*nWidth,nTop=row*nHeight;_oContext.strokeStyle=bIsDark?_htOption.colorDark:_htOption.colorLight,_oContext.lineWidth=1,_oContext.fillStyle=bIsDark?_htOption.colorDark:_htOption.colorLight,_oContext.fillRect(nLeft,nTop,nWidth,nHeight),_oContext.strokeRect(Math.floor(nLeft)+.5,Math.floor(nTop)+.5,nRoundedWidth,nRoundedHeight),_oContext.strokeRect(Math.ceil(nLeft)-.5,Math.ceil(nTop)-.5,nRoundedWidth,nRoundedHeight)
}this._bIsPainted=!0},Drawing.prototype.makeImage=function(){this._bIsPainted&&_safeSetDataURI.call(this,_onMakeImage)},Drawing.prototype.isPainted=function(){return this._bIsPainted},Drawing.prototype.clear=function(){this._oContext.clearRect(0,0,this._elCanvas.width,this._elCanvas.height),this._bIsPainted=!1},Drawing.prototype.round=function(nNumber){return nNumber?Math.floor(1e3*nNumber)/1e3:nNumber},Drawing}():function(){var Drawing=function(el,htOption){this._el=el,this._htOption=htOption};return Drawing.prototype.draw=function(oQRCode){for(var _htOption=this._htOption,_el=this._el,nCount=oQRCode.getModuleCount(),nWidth=Math.floor(_htOption.width/nCount),nHeight=Math.floor(_htOption.height/nCount),aHTML=['<table style="border:0;border-collapse:collapse;">'],row=0;nCount>row;row++){aHTML.push("<tr>");
for(var col=0;nCount>col;col++)aHTML.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:'+nWidth+"px;height:"+nHeight+"px;background-color:"+(oQRCode.isDark(row,col)?_htOption.colorDark:_htOption.colorLight)+';"></td>');aHTML.push("</tr>")}aHTML.push("</table>"),_el.innerHTML=aHTML.join("");var elTable=_el.childNodes[0],nLeftMarginTable=(_htOption.width-elTable.offsetWidth)/2,nTopMarginTable=(_htOption.height-elTable.offsetHeight)/2;nLeftMarginTable>0&&nTopMarginTable>0&&(elTable.style.margin=nTopMarginTable+"px "+nLeftMarginTable+"px")},Drawing.prototype.clear=function(){this._el.innerHTML=""},Drawing}();return QRCode=function(el,vOption){if(this._htOption={width:256,height:256,typeNumber:4,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRErrorCorrectLevel.H},"string"==typeof vOption&&(vOption={text:vOption}),vOption)for(var i in vOption)this._htOption[i]=vOption[i];
"string"==typeof el&&(el=document.getElementById(el)),this._htOption.useSVG&&(Drawing=svgDrawer),this._android=_getAndroid(),this._el=el,this._oQRCode=null,this._oDrawing=new Drawing(this._el,this._htOption),this._htOption.text&&this.makeCode(this._htOption.text)},QRCode.prototype.makeCode=function(sText){this._oQRCode=new QRCodeModel(_getTypeNumber(sText,this._htOption.correctLevel),this._htOption.correctLevel),this._oQRCode.addData(sText),this._oQRCode.make(),this._el.title=sText,this._oDrawing.draw(this._oQRCode),this.makeImage()},QRCode.prototype.makeImage=function(){"function"==typeof this._oDrawing.makeImage&&(!this._android||this._android>=3)&&this._oDrawing.makeImage()
},QRCode.prototype.clear=function(){this._oDrawing.clear()},QRCode.CorrectLevel=QRErrorCorrectLevel,QRCode}),define("taoQtiPrint/runner/testRunner",["jquery","lodash","async","helpers","taoQtiPrint/runner/itemRunner","taoQtiPrint/lib/qrcode"],function($,_,async,helpers,itemRunner,QRCode){"use str11ict";var testRenderer={createPage:function(type){return $("<section></section>").addClass(type)},testPage:function(test,done){{var $testPage=this.createPage("title"),$codeElt=$('<div class="qr-code">');new QRCode($codeElt[0],{text:helpers._url("render","PrintTest","taoBooklet",{uri:test.uri}),width:192,height:192,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H})
}$testPage.append("<h1>"+test.title+"</h1>").append($codeElt),done(null,$testPage)},sectionPage:function(section,pageNum,done){var $sectionPage=this.createPage("section");$sectionPage.append("<h2>"+section.title+"</h2>"),_.forEach(section.rubricBlock,function(rubricBlock){$sectionPage.append("<div>"+rubricBlock+"</div>")}),done(null,$sectionPage)},itemPage:function(item,uri,pageNum,done){var $itemContainer=this.createPage("item");itemRunner("qtiprint",item,{uri:uri}).on("error",function(err){done(err)}).on("render",function(){done(null,$itemContainer)}).init().render($itemContainer)}},testRunnerFactory=function(testData,options){if(testData=testData||{},!testData||!testData.data||!testData.items)throw new Error("Invalid test data structure");
var events={},testRunner={$container:null,render:function(elt){var self=this,pageRenderers=[];return elt instanceof HTMLElement||elt instanceof $?(this.$container=elt instanceof $?elt:$(elt),pageRenderers.push(_.bind(_.partial(testRenderer.testPage,testData.data),testRenderer)),_.forEach(testData.data.testParts,function(testPart){_.forEach(testPart.sections,function(section){pageRenderers.push(_.bind(_.partial(testRenderer.sectionPage,section,pageRenderers.length),testRenderer)),_.forEach(section.items,function(item){testData.items[item.href]&&testData.items[item.href].data&&pageRenderers.push(_.bind(_.partial(testRenderer.itemPage,testData.items[item.href].data,item.href,pageRenderers.length),testRenderer))
})})}),async.parallel(pageRenderers,function(err,$results){err&&self.trigger("error","An error occurred while rendering a page :  "+err),options&&options.rtl===!0&&self.$container.addClass("rtl").attr("dir","rtl"),self.$container.empty().append($results),self.trigger("render"),self.trigger("ready")}),this):self.trigger("error","A valid HTMLElement (or a jquery element) at least is required to render the test")},clear:function(){return this.$container.empty(),this.trigger("clear"),this},on:function(name,handler){return _.isString(name)&&_.isFunction(handler)&&(events[name]=events[name]||[],events[name].push(handler)),this},off:function(name){return _.isString(name)&&(events[name]=[]),this
},trigger:function(name,data){var self=this;return _.isString(name)&&_.isArray(events[name])&&_.forEach(events[name],function(event){event.call(self,data)}),this}};return testRunner};return testRunnerFactory}),define("taoBooklet/controller/printtest/render",["jquery","taoQtiPrint/runner/testRunner"],function($,testRunner){var ready=function(){window.status="runner-ready"},showMessage=function(msg,type){type=type||"info",$("body").append('<div class="feedback-'+type+'">'+msg+"</div>")},printLayoutHacking=function($container){var previous,threshold=6e3,pages=2,blankPage=function($section){$section.before('<div class="breaker"></div>'),pages++},computePageFromHeight=function(height){height>threshold&&(pages+=Math.ceil(height/threshold)-1)
};$container.children("section").each(function(){var height,$section=$(this);$section.hasClass("section")&&(pages%2===0&&blankPage($section),computePageFromHeight($section.outerHeight()),previous="section",pages++),$section.hasClass("item")&&("item"!==previous&&(pages%2!==0&&blankPage($section),height=$section.outerHeight(),$section.nextUntil(".section",".item").each(function(){height+=$(this).outerHeight()}),computePageFromHeight(height),pages++),previous="item")})},renderController={start:function(testData,options){setTimeout(function(){showMessage("Something went wrong...","error"),ready()},45e3);var $mainContainer=$("<main>");testRunner(testData,options).on("error",function(e){console.error(e),showMessage(e,"error"),ready()
}).on("ready",function(){$("body").append($mainContainer),printLayoutHacking($mainContainer),ready()}).render($mainContainer)}};return renderController}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))}('html{-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;font-size:62.5%;line-height:1.4;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover}body{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:14px}::-webkit-scrollbar-corner{background-color:ThreeDHighlight}html *,html *:before,html *:after{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}html,html body{color:#222;font-family:"Franklin Gothic","Franklin Gothic Medium","Source Sans Pro",sans-serif;font-weight:normal;margin:0;padding:0;position:relative;height:100%;z-index:0;line-height:1.4;background:white;border-width:1px}html address,html article,html aside,html audio,html blockquote,html dd,html div,html dl,html fieldset,html figcaption,html figure,html footer,html form,html h1,html h2,html h3,html h4,html h5,html h6,html header,html hr,html noscript,html ol,html output,html p,html pre,html section,html summary,html ul,html main{margin-top:0;padding-top:0;padding-bottom:0;white-space:normal}html h1{font-size:2em;margin:0.67em 0}html h2{font-size:1.5em;margin:0.83em 0}html h3{font-size:1.17em;margin:1em 0}html h4{font-size:1em;margin:1.33em 0}html h5{font-size:0.83em;margin:1.67em 0}html h6{font-size:0.67em;margin:2.33em 0}html blockquote{margin:1em 40px}html blockquote,html dd,html dl,html fieldset,html figure,html h1,html h2,html h3,html h4,html h5,html h6,html hr,html ol,html p,html pre,html ul{display:block;margin-bottom:10px;white-space:normal}html h1,html h2,html h3,html h4,html h5,html h6{font-weight:normal;font-style:normal}html iframe{border:none}html audio,html canvas,html video,html svg{display:inline-block;vertical-align:middle}html a,html .a{cursor:pointer;background:transparent;text-decoration:none;outline:0;color:#3e7da7}html a:focus,html .a:focus{outline:thin dotted}html a:hover,html .a:hover{text-decoration:underline;color:#0e5d91}html a:hover:before,html a:hover:after,html .a:hover:before,html .a:hover:after{text-decoration:none !important}html a.block,html .a.block{color:#222;text-decoration:none;display:block}html a[rel="external"] span.icon-external:before,html .a[rel="external"] span.icon-external:before{font-size:11px;font-size:1.1rem;padding:0 0 0 4px;position:relative;top:1px}html abbr[title]{border-bottom:1px dotted}html b,html .b,html strong,html .strong{font-weight:bold}html i,html .i,html em,html .em,html dfn{font-style:italic}html code,html pre,html kdb,html samp{font-family:Consolas,"Andale Mono WT","Andale Mono","Lucida Console","Lucida Sans Typewriter","DejaVu Sans Mono","Bitstream Vera Sans Mono","Liberation Mono","Nimbus Mono L",Monaco,"Courier New",Courier,monospace;font-size:14px;font-size:1.4rem}html pre{white-space:pre;white-space:pre-wrap;word-wrap:break-word}html code{background:#f1f5f7;padding:2px 6px;display:inline-block;margin:0 3px;-moz-border-radius:2px;-webkit-border-radius:2px;border-radius:2px}html hr{display:block;height:1px;border:0;border-top:1px solid #ccc;margin:1em 0;padding:0}html q{quotes:"\\201C" "\\201D" "\\2018" "\\2019"}html q:before,html q:after{content:\'\';content:none}html small{font-size:11px;font-size:1.1rem}html sub,html sup{font-size:.75rem;line-height:0;position:relative;vertical-align:baseline}html sup{top:-0.5rem}html sub{bottom:-0.25rem}html img{border:0;max-width:100%}html svg:not(:root){overflow:hidden}html ul.armenian,html ol.armenian{list-style-type:armenian}html ul.circle,html ol.circle{list-style-type:circle}html ul.cjk-ideographic,html ol.cjk-ideographic{list-style-type:cjk-ideographic}html ul.decimal,html ol.decimal{list-style-type:decimal}html ul.decimal-leading-zero,html ol.decimal-leading-zero{list-style-type:decimal-leading-zero}html ul.disc,html ol.disc{list-style-type:disc}html ul.georgian,html ol.georgian{list-style-type:georgian}html ul.hebrew,html ol.hebrew{list-style-type:hebrew}html ul.hiragana,html ol.hiragana{list-style-type:hiragana}html ul.hiragana-iroha,html ol.hiragana-iroha{list-style-type:hiragana-iroha}html ul.katakana,html ol.katakana{list-style-type:katakana}html ul.katakana-iroha,html ol.katakana-iroha{list-style-type:katakana-iroha}html ul.lower-alpha,html ol.lower-alpha{list-style-type:lower-alpha}html ul.lower-greek,html ol.lower-greek{list-style-type:lower-greek}html ul.lower-latin,html ol.lower-latin{list-style-type:lower-latin}html ul.lower-roman,html ol.lower-roman{list-style-type:lower-roman}html ul.square,html ol.square{list-style-type:square}html ul.upper-alpha,html ol.upper-alpha{list-style-type:upper-alpha}html ul.upper-latin,html ol.upper-latin{list-style-type:upper-latin}html ul.upper-roman,html ol.upper-roman{list-style-type:upper-roman}html ul.none,html ol.none{list-style-type:none}html ul,html ol{padding-left:40px}html ul.plain,html ul.none,html ol.plain,html ol.none{padding:0;margin:0;list-style:none}html ul li,html ol li{vertical-align:text-top !important}html nav ul{padding:0;margin:0;list-style:none}html fieldset{border:0;margin:0;padding:0}html legend{border:0;padding:0}html textarea{overflow:auto;vertical-align:top;resize:vertical}html table{border-collapse:collapse;border-spacing:0;margin:0;padding:0}html .tbl{display:table;float:none !important}html .tbl-row{display:table-row;float:none !important}html .tbl-cell{display:table-cell;vertical-align:top;float:none !important}html table.matrix{width:100%;border:6px solid #f9f8f7;margin-bottom:10px}html table.matrix td,html table.matrix th{font-weight:normal;padding:3px 5px;border:1px solid #ddd}html table.matrix th{text-align:left;vertical-align:middle;background:#f9f8f7}html table.matrix td{background:transparent;text-align:left;padding:2px}html table.matrix td.numeric{text-align:right}html table.matrix td label{display:block;margin:0}html table.matrix tr:nth-child(even){background:white}html table.matrix tr:nth-child(odd){background:#f4f7f8}html table.matrix [data-edit],html table.matrix [data-edit] *{border:none;padding:6px;cursor:pointer}html table.matrix tbody [data-edit]{width:30px}html label,html button{cursor:pointer}html button{vertical-align:middle;outline:0;overflow:visible;border:none}html button::-moz-focus-inner,html input::-moz-focus-inner{border:0;padding:0}html button,html input,html select,html textarea{font-family:"Franklin Gothic","Franklin Gothic Medium","Source Sans Pro",sans-serif;font-weight:normal;line-height:normal;text-transform:none;vertical-align:baseline}html button,html html input[type="button"],html input[type="reset"],html input[type="submit"]{-webkit-appearance:button;cursor:pointer}html input{border:1px solid #ddd;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:1px;-webkit-border-radius:1px;border-radius:1px}html input[type="search"]{-webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}html input[type="search"]::-webkit-search-cancel-button,html input[type="search"]::-webkit-search-decoration{-webkit-appearance:none}html input[type="checkbox"],html input[type="radio"]{box-sizing:border-box;padding:0}html select{max-width:100%}html audio:not([controls]),html [hidden],html template,html .hidden,html .deleted,html .js,html .js-hide{display:none !important}html .visuallyhidden{border:0;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px}html .visuallyhidden.focusable:active,html .visuallyhidden.focusable:focus{clip:auto;height:auto;margin:0;overflow:visible;position:static;width:auto}html .invisible{visibility:hidden}html .viewport-hidden{position:absolute;left:-10000px;top:-10000px}html .clearfix:before,html .grid-row:before,html .fixed-grid-row:before,html #icon-editor .grid-row:before,#icon-editor html .grid-row:before,html .clearfix:after,html .grid-row:after,html .fixed-grid-row:after,html #icon-editor .grid-row:after,#icon-editor html .grid-row:after{content:" ";display:table}html .clearfix:after,html .grid-row:after,html .fixed-grid-row:after,html #icon-editor .grid-row:after,#icon-editor html .grid-row:after{clear:both}html .clear{display:block;clear:both}html .lft{display:inline;float:left}html .rgt{display:inline;float:right}html .txt-ctr{text-align:center}html .txt-lft{text-align:left}html .txt-rgt{text-align:right}html .txt-jty{text-align:justify}html .txt-underline{text-decoration:underline}html ::-moz-selection{background:#b3d4fc;text-shadow:none}html ::selection{background:#b3d4fc;text-shadow:none}html .placeholder{color:#777 !important}html ::-webkit-input-placeholder{color:#777 !important}html :-moz-placeholder{color:#777 !important}html ::-moz-placeholder{color:#777 !important}html .truncate{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}html .disabled,html *:disabled{cursor:default;opacity:.7}html .overlay,html .ui-widget-overlay{background:rgba(255,255,255,0.9)}html .ui-widget{font-family:"Franklin Gothic","Franklin Gothic Medium","Source Sans Pro",sans-serif;font-size:1.4rem !important}html .ui-widget .ui-widget{font-size:1.4rem !important}html .ui-widget input,html .ui-widget select,html .ui-widget textarea,html .ui-widget button{font-family:"Franklin Gothic","Franklin Gothic Medium","Source Sans Pro",sans-serif;font-size:1.4rem !important}*,*:before,*:after{background:transparent;color:#000;box-shadow:none !important;text-shadow:none !important}a,a:visited{text-decoration:underline}a[href]:after{content:" (" attr(href) ")"}abbr[title]:after{content:" (" attr(title) ")"}a[href^="#"]:after,a[href^="javascript:"]:after{content:""}pre,blockquote{border:1px solid #999;page-break-inside:avoid}thead{display:table-header-group}tr,img{page-break-inside:avoid}img{max-width:100% !important}p,h2,h3{orphans:3;widows:3}h2,h3{page-break-after:avoid}[class^="feedback-"],[class*=" feedback-"]{border:1px transparent solid;position:relative;padding:20px 20px 20px 45px;margin:5px 0 10px 0;border-radius:3px;color:#222 !important}[class^="feedback-"].small,[class*=" feedback-"].small{padding:8px 20px 8px 45px}[class^="feedback-"].small [class^="icon-"],[class^="feedback-"].small [class*=" icon-"],[class*=" feedback-"].small [class^="icon-"],[class*=" feedback-"].small [class*=" icon-"]{top:9px;left:10px}[class^="feedback-"] [class^="icon-"],[class^="feedback-"] [class*=" icon-"],[class*=" feedback-"] [class^="icon-"],[class*=" feedback-"] [class*=" icon-"]{font-size:20px;font-size:2rem;position:absolute;top:20px;left:15px}[class^="feedback-"] [class^="icon-"].icon-close,[class^="feedback-"] [class^="icon-"].icon-remove,[class^="feedback-"] [class*=" icon-"].icon-close,[class^="feedback-"] [class*=" icon-"].icon-remove,[class*=" feedback-"] [class^="icon-"].icon-close,[class*=" feedback-"] [class^="icon-"].icon-remove,[class*=" feedback-"] [class*=" icon-"].icon-close,[class*=" feedback-"] [class*=" icon-"].icon-remove{font-size:15px;font-size:1.5rem;color:#999;left:auto;top:5px;cursor:pointer}[class^="feedback-"] [class^="icon-"].icon-close:hover,[class^="feedback-"] [class^="icon-"].icon-remove:hover,[class^="feedback-"] [class*=" icon-"].icon-close:hover,[class^="feedback-"] [class*=" icon-"].icon-remove:hover,[class*=" feedback-"] [class^="icon-"].icon-close:hover,[class*=" feedback-"] [class^="icon-"].icon-remove:hover,[class*=" feedback-"] [class*=" icon-"].icon-close:hover,[class*=" feedback-"] [class*=" icon-"].icon-remove:hover{color:#222}[class^="feedback-"] [class^="icon-"].icon-remove,[class^="feedback-"] [class*=" icon-"].icon-remove,[class*=" feedback-"] [class^="icon-"].icon-remove,[class*=" feedback-"] [class*=" icon-"].icon-remove{right:24px}[class^="feedback-"] [class^="icon-"].icon-close,[class^="feedback-"] [class*=" icon-"].icon-close,[class*=" feedback-"] [class^="icon-"].icon-close,[class*=" feedback-"] [class*=" icon-"].icon-close{right:7px}[class^="feedback-"].popup,[class*=" feedback-"].popup{display:block;position:fixed;top:50px;left:50%;margin-left:-200px;width:400px;z-index:999999}.feedback-error{border-color:#c74155;background-color:#f8e7e9}.feedback-error .icon-error{color:#ba122b !important}.feedback-info{border-color:#3e7da7;background-color:#e6eef4}.feedback-info .icon-info,.feedback-info .icon-lock{color:#0e5d91 !important}.feedback-info .button-container{margin-top:20px}.feedback-success{border-color:#3ea76f;background-color:#e6f4ed}.feedback-success .icon-success{color:#0e914b !important}.feedback-warning{border-color:#dfbe7b;background-color:#fbf6ee}.feedback-warning .icon-warning{color:#d8ae5b !important}.brd-error{border:1px solid #c74155 !important}.brd-info{border:1px solid #3e7da7 !important}.brd-success{border:1px solid #3ea76f !important}.brd-warning{border:1px solid #dfbe7b !important}.txt-error{color:#ba122b !important}.txt-info{color:#0e5d91 !important}.txt-success{color:#0e914b !important}.txt-warning{color:#d8ae5b !important}.bg-error{background-color:#f8e7e9}.bg-info{background-color:#e6eef4}.bg-success{background-color:#e6f4ed}.bg-warning{background-color:#fbf6ee}[class*=" col-"],[class^="col-"]{float:left;min-height:1rem}[class*=" col-"]:first-child,[class^="col-"]:first-child{margin-left:0}[class*=" col-"].grid-container,[class^="col-"].grid-container{margin-bottom:0}.col-12{float:none}.grid-container{overflow-x:hidden}.grid-row,.fixed-grid-row{width:101.42857%}.col-1{margin-left:1.42857%;width:6.90476%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-2{margin-left:1.42857%;width:15.2381%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-3{margin-left:1.42857%;width:23.57143%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-4{margin-left:1.42857%;width:31.90476%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-5{margin-left:1.42857%;width:40.2381%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-6{margin-left:1.42857%;width:48.57143%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-7{margin-left:1.42857%;width:56.90476%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-8{margin-left:1.42857%;width:65.2381%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-9{margin-left:1.42857%;width:73.57143%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-10{margin-left:1.42857%;width:81.90476%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-11{margin-left:1.42857%;width:90.2381%;margin-bottom:12px}.alpha{margin-left:0 !important}.col-12{margin-left:1.42857%;width:98.57143%;margin-bottom:12px}.alpha{margin-left:0 !important}#icon-editor .grid-row{width:100%}#icon-editor .col-1{margin-left:0%;width:8.33333%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-2{margin-left:0%;width:16.66667%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-3{margin-left:0%;width:25%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-4{margin-left:0%;width:33.33333%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-5{margin-left:0%;width:41.66667%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-6{margin-left:0%;width:50%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-7{margin-left:0%;width:58.33333%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-8{margin-left:0%;width:66.66667%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-9{margin-left:0%;width:75%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-10{margin-left:0%;width:83.33333%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-11{margin-left:0%;width:91.66667%;margin-top:0 !important;margin-bottom:0 !important}#icon-editor .col-12{margin-left:0%;width:100%;margin-top:0 !important;margin-bottom:0 !important}html{box-sizing:border-box;height:auto;background:white;color:black}html body{font:12pt/1.2 Cambria, \'Hoefler Text\', Utopia, \'Liberation Serif\', \'Nimbus Roman No9 L Regular\', Times, \'Times New Roman\', serif;height:auto;background:white}html h1,html h2,html h3,html h4,html h5,html h6{font-weight:bold}html h1{font-size:22pt;margin:12pt 0}html h2{font-size:20pt;margin:10pt 0}html h3{font-size:18pt;margin:10pt 0}html h4{font-size:16pt;margin:9pt 0}html h5{font-size:14pt;margin:9pt 0}html h6{font-size:12pt;margin:8pt 0}*,*:before,*:after{box-sizing:inherit}[dir="rtl"],.rtl{direction:rtl}[dir="rtl"] menu,[dir="rtl"] ol,[dir="rtl"] ul,.rtl menu,.rtl ol,.rtl ul{padding:0px 40px 0px 0px}main>section.title h1{font-size:24pt;text-align:center}main>section.title .qr-code img{margin:auto}main>section.intro{page-break-after:always}main>section.section{page-break-before:always;page-break-after:always}main>section.item{page-break-inside:avoid;page-break-after:auto;padding-bottom:10px;margin-bottom:10px}main>.breaker{page-break-before:always;page-break-after:always;height:1px}article h1{font-size:20pt}article h2{font-size:18pt}article h3{font-size:16pt}article h4{font-size:14pt}article h5{font-size:13pt}article h6{font-size:12pt}.qti-item{padding:0;background:transparent;max-width:none}.qti-item .qti-blockInteraction{padding:10pt;border:1px dashed grey}.qti-item .qti-interaction-answer{width:100%;border:10px solid grey;padding:20px}.qti-item pre{padding:10pt;font-size:12pt;border-style:dashed;font-family:Consolas,"Andale Mono WT","Andale Mono","Lucida Console","Lucida Sans Typewriter","DejaVu Sans Mono","Bitstream Vera Sans Mono","Liberation Mono","Nimbus Mono L",Monaco,"Courier New",Courier,monospace}.qti-item input[type="text"]{padding:5pt}.qti-item .qti-extendedTextInteraction textarea{display:block;padding:10pt;font-size:12pt;border:1px dashed #000;font-family:Consolas,"Andale Mono WT","Andale Mono","Lucida Console","Lucida Sans Typewriter","DejaVu Sans Mono","Bitstream Vera Sans Mono","Liberation Mono","Nimbus Mono L",Monaco,"Courier New",Courier,monospace;width:100%;min-height:150px;background:#eee}.qti-item input.qti-textEntryInteraction{border:none;border-bottom:dashed #000 1px;background-color:#eee;border-radius:2px}.qti-choiceInteraction ol{list-style-type:none;padding:0;margin:0}.qti-choiceInteraction .qti-choice{clear:both;margin-bottom:3px}.qti-choiceInteraction .qti-choice input[type="radio"],.qti-choiceInteraction .qti-choice input[type="checkbox"]{display:none}.qti-choiceInteraction .qti-choice input[type="checkbox"]+label,.qti-choiceInteraction .qti-choice input[type="radio"]+label{display:block}.qti-choiceInteraction .qti-choice input[type="checkbox"]+label:before,.qti-choiceInteraction .qti-choice input[type="radio"]+label:before{content:\' \';float:left;width:14px;height:14px;margin:0 6px 0 3px;border:solid #000 1px;background-color:#eee;border-radius:2px;font-size:14px;line-height:14px;text-align:center;position:relative;top:3px}.qti-choiceInteraction .qti-choice input[type="checkbox"]:checked+label:before,.qti-choiceInteraction .qti-choice input[type="radio"]:checked+label:before{content:\'\\00d7\'}.rtl .qti-choiceInteraction .qti-choice input[type="checkbox"]+label,.rtl .qti-choiceInteraction .qti-choice input[type="radio"]+label{display:block}.rtl .qti-choiceInteraction .qti-choice input[type="checkbox"]+label:before,.rtl .qti-choiceInteraction .qti-choice input[type="radio"]+label:before{content:\' \';float:right;margin:0 3px 0 6px;border:solid #000 1px}@media screen{html body{margin:10px}html body>main{border:solid 1px #ccc;border-radius:6px;box-shadow:0 0 3px 0 #444 !important;background-color:white;padding:15px}}\n/*# sourceMappingURL=qti.css.map */\n');
